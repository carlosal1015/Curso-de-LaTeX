...
\begin{frame}
	...
	Una caja es un objeto rectangular con altura, profundidad y anchura.
	...
	que se comporta de forma similar a un carácter (potencialmente enorme).
	...
	\begin{description}
		\item[Izquierda derecha]
		      ...
		      El contenido de esta caja se compone de izquierda a derecha.
