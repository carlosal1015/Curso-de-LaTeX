...
El día de hoy (11/12/17) vamos a iniciar con algunos ejemplos básicos
en LaTeX y se explicará paso a paso.
...
\end{document}
```
Muy bien, podemos identificar que un documento está formado por tres
partes: el comando `\documentclass[optional]{obligatory}` en el cual
los parámetros opcionales pueden ser a4, 12pt, entre otros y dentro
de las llaves tenemos la siguiente palestra de "sabores"
(¡pero solo una por documento!) `book`, `beamer`, `report`, `letter`,
`memoir` y muchos más.
Las otras dos partes que tienen extensión variable son la lista de
paquetes `\usepackage[optional]{obligatory}` (en el ejemplo se ha
mostrado los más populares) y el cuerpo que siempre va entre
...
<p align="center">
  <img src="https://raw.githubusercontent.com/carlosal1015/Curso-de-LaTeX/refs/heads/master/Ubuntu%20Colombia/Curso%20Vacacional%20B%C3%A1sico/Clases/Clase%201/images/exercise1_1.png"
	width="250">
</p>
...
```
> **Observaciones**
- Hemos creado una lista numerada con el paquete `\usepackage[shortlabels]{enumitem}` y con el comando `\begin{enumerate}[x]\end{enumerate}` donde x puede ser un número, una letra u otro símbolo.
- Es importante siempre utilizar `\item`, su omisión es causa muy frecuente de errores.

<p align="center">
  <img src="https://raw.githubusercontent.com/carlosal1015/Curso-de-LaTeX/refs/heads/master/Ubuntu%20Colombia/Curso%20Vacacional%20B%C3%A1sico/Clases/Clase%201/images/exercise1_2.png"
	width="250">
</p>
