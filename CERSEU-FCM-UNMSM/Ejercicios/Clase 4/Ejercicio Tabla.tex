...
\begin{table}[h]
	...
	\begin{tabular}{lc}
		...
		\hline
	\end{tabular}
	\caption*{\scriptsize Fuente: Ined, 2011}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|l|}
		\hline                          &      & \bf Población \\
		\hline
		\multirow {3}{1.5cm}{\bf Censo} & 1981 &               \\
		                                & 1993 &               \\
		                                & 2007 &               \\
		\hline
	\end{tabular}
...
\begin{table}
	...
	\begin{tabular}{|c|c|c|}
		\hline Texto 1 & \rotatebox{90}{Texto 2\,} & Texto 3 \\
		\hline Dato1   & Dato2                     & Dato3   \\
		\hline
	\end{tabular}
\end{table}
...
\begin{table}[h]
	\centering
	\parbox{5cm}{\caption{ \centering {Selección de países de América del Sur-2011: Población (en millones)}}} \\
	{\rowcolors{2}{cyan!80!blue!50}{cyan!70!white!40}
	\begin{tabular}{ l c}
		\hline País    & Población \\
		\hline Bolivia & 10.1      \\
		Chile          & 17.3      \\
	...
	\parbox{5cm}{\hspace{0.5cm} {\footnotesize Fuente: Ined, 2011}}
\end{table}
\end{document}
